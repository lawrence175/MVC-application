...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      ...
      <p><h3>This mainly targets community development at family levels! We train the community
      in various marketable skills, give good health practice trainings. We majorly do
      activities aimed at developing the community example, building wells, public toilets,
      giving out water tanks, digging roads, supplementary feeding for recognized
      malnourished people in given families.<b>
      </h3> </p>
      <div id="portfolio">
        <ul class="nospace clear">
          <li class="one_half first">
            <article><img class="borderedbox" src="../images/demo/portfolio/water_security.jpg" alt="">
              <h2>Community Water Security</h2>
              <p>We have so far built four water soures/boreholes in four communities,to enable poor families to have access to clean water</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images/demo/portfolio/image_2.jpg" alt="">
              <h2>Community Children home visiting</h2>
              <p>community description to be addded Here!!!!!!!!!..</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          </li>
          <li class="one_half first">
            <article><img class="borderedbox" src="../images/demo/portfolio/image_3.jpg" alt="">
              <h2>School Visiting</h2>
              <p>community description to be addded Here!!!!!!!!!..</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images/demo/portfolio/image_4.jpg" alt="">
              <h2>community children description</h2>
              <p>community description to be addded Here!!!!!!!!!...</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          </li>
          <li class="one_half first">
            <article><img class="borderedbox" src="../images/demo/portfolio/image_5.jpg" alt="">
              <h2>community children description</h2>
              <p>community description to be addded Here!!!!!!!!!...</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          ...
          <li class="one_half">
            <article><img class="borderedbox" src="../images/demo/portfolio/image_6.jpg" alt="">
              <h2>Church fellowship</h2>
              <p>community description to be addded Here!!!!!!!!!....</p>
              <p class="right"><a href="#">Read More Here &raquo;</a></p>
            </article>
          </li>
