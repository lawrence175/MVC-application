    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="#" href="about.php">WHO WE ARE</a>
          <li><a class="drop" href="#">GET INVOLED</a>
            <ul>
...
$sql = "INSERT into volunteer (gender,surname,lastname,email,age,country,department,message, submittedby,created_date) VALUES('" . $gender . "','" . $surname . "','" . $lastname . "','" . $email . "','" . $age . "','" . $country . "','" . $department . "','" . $message . "' , '" . $submittedby . "' ,'" . date('Y-m-d') . "')";
