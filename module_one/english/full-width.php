...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
      <!-- ################################################################################################ -->
      <h3>We have Five regions,we operate across Uganda:</h3>
      ...
      <h1>Regions where we carryout Fellowships,practical christian activities,Campsites etc.</h1>
      <div class="scrollable">
          <table width="100%" border="1">
            <tr>
              <th align="center">Co-ordinator</th>
          ...
          <tbody>
              <tr>
                  <td><a href="#"></a></td>
                  <td>TMA-Central Uganda</td>
                  <td>Bible study,Contruction of public toilets,Child Skills training,Water Security..etc.</td>
                  <td>Praying and Fasting</td>
                </tr>
                <tr>
            <tr>
              <td><a href="#"></a></td>
              <td>TMA-Eastern Uganda</td>
              <td>Children Campsites,Crusades</td>
              <td>Bible study</td>
            </tr>
            <tr>
              <td></td>
              <td>TMA-Western Uganda</td>
              <td>Children's camp,Fellowships</td>
              <td><a href="#">Visible spiritual transformation of children</a></td>
            </tr>
            <tr>
              <td></td>
              <td>TMA-Northern Uganda</td>
              <td>Carry out health screening,commerate world AIDS day</td>
              <td>To mitigate the dangers that come with poor hygiene</td>
            </tr>
            <tr>
              <td></td>
              <td><a href="#">TMA-southern Uganda</a></td>
