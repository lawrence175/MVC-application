...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
      <!-- ################################################################################################ -->
      <h4>Child Outreach Program</h4>
      <p>Where we look at the mental, social and health development of the children and
      youths. We provide them with quality formal and informal education, train them good
      health practices, nurture them in talent development and train them in livelihood skills
      leading them to being self-sustained and job creator Christians.</p><br>

      <div id="portfolio">
        <ul class="nospace clear">
          <li class="one_half first">
              <article><img class="borderedbox" src="../images/demo/portfolio/child_1.jpg" alt="">
              <h2>Title description for the project</h2>
              <p>project description will be right here, and describe activities</p>
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images/demo/portfolio/child_2.jpg" alt="">
              <h2>School visiting</h2>
              <p>project description will be right here, and describe activities</p>
            </article>
          </li>
          <li class="one_half first">
            <article><img class="borderedbox" src="../images/demo/portfolio/child_3.jpg" alt="">
              <h2>Title description for the project</h2>
              <p>project description will be right here, and describe activities.</p>
            </article>
          </li>
          <li class="one_half">
            <article><img class="borderedbox" src="../images/demo/portfolio/child_4.jpg" alt="">
              <h2>Title description for the project</h2>
              <p>project description will be right here, and describe activities.</p>
            </article>
          </li>
